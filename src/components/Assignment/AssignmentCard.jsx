                    ...
                    fetch(`http://localhost:5000/assignments/${_id}`, {
                        ...
                        .then(data => {
                            ...
                            if (data.deletedCount > 0) {
                                ...
                                const remains = assign.filter(singleItem => singleItem._id !== _id);
                                setAssign(remains);
                            }
                        })
                }
    ...
    return (
        <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div className="text-center">
                ...
                <button className="btn btn-wide  bg-orange-500 text-white">View Details</button>
                </Link>
                <Link><button onClick={() => handleDelete(_id)} type="button" className=" btn flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50">Delete</button></Link>
